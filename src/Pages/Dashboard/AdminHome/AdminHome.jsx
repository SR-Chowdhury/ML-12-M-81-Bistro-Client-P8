...
const AdminHome = () => {
    ...
    return (
        <div className='w-full px-10'>
            ...
            <h1 className='text-3xl mt-16 mb-6'>Hi, Welcome Back {user.displayName}!</h1>
            <div>
                <div className="stats shadow">
                    ...
                    <div className="stat">
                        ...
                        <div className="stat-title text-2xl">Revinew</div>
                        <div className="stat-value text-primary">${stats.revinew}</div>
                    </div>
